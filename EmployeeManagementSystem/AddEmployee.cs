...
namespace EmployeeManagementSystem
{
    public partial class AddEmployee : UserControl
    {
                ...
                if(connect.State == ConnectionState.Closed)
                {
                    try
                    {
                        ...
                        using(SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            if(count >= 1)
                            {
                                MessageBox.Show(addEmployee_id.Text.Trim() + " Da ton tai"
                                    , "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            }
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\LUU HUU DUOC\Documents\Visual Studio 2022\project1\EmployeeManagementSystem\EmployeeManagementSystem\Directory\"
        ...
        private void addEmployee_updateBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult check = MessageBox.Show("Ban co muon cap nhat" +
                    "Nhan vien ID: " + addEmployee_id.Text.Trim() + "?", "Thong bao"
        ...
        private void addEmployee_deleteBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult check = MessageBox.Show("Ban chac chan muon xoa " +
                    "nhan vien ID: " + addEmployee_id.Text.Trim() + "?", "Thong bao"
                    , MessageBoxButtons.YesNo, MessageBoxIcon.Information);
